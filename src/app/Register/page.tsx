...
import { FaFacebook, FaLinkedin, FaGoogle, FaFacebookF } from "react-icons/fa";
        ...
        <main className="flex flex-col items-center justify-center w-full flex-1 px-4 md:px-20 text-center">
          <div className="z-20 bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl shadow-2xl flex flex-col md:flex-row w-full md:w-2/3 max-w-4xl">
            ...
            <div className="w-full  p-5">
              ...
              <p className="text-gray-400 my-3">or register manually</p>
              <div className="flex flex-col items-center">
                <div className="bg-gray-200 w-full md:w-64 p-1 flex items-center mb-3">
                  <input type="input" name="name" placeholder="name" className="bg-gray-200 outline-none text-sm flex-1"/>
                </div>
                <div className="bg-gray-200 w-full md:w-64 p-1 flex items-center mb-3">
                ...
                <a href="Profile" className="bg-slate-700 text-white rounded-full px-12 py-1 inline-block font-semibold hover:bg-white hover:text-slate-700">Sign Up</a>
              </div>
            </div>
            {/* End of Sign  in form */}
